...
public class ComplexTest {
    ...
    void testHashCode() {
     ...
     @Test
    void testEquals(){
        Complex trueValue1 = new Complex(1,1);
        Complex trueValue2 = new Complex(1,1);
        Complex falseValue1 = new Complex(1,0);
        Complex falseValue2 = new Complex (0,1);
        assertEquals(trueValue1.equals(trueValue2),true);
    ...
    @Test
    void testPow(){
        Complex complexNum = new Complex(2,1);

        assertEquals(Complex.ONE,complexNum.pow(0));
        assertEquals(complexNum,complexNum.pow(1));
    ...
    @Test
    void testAdd(){
        assertEquals(Complex.I,minusOne.add(onePlusI));
        assertEquals(new Complex(2,0),Complex.ZERO.add(two));

    }
    @Test
    void testModulus(){
        assertEquals(Math.sqrt(2),new Complex(1,1).modulus());
        assertEquals(1,  Complex.ONE.modulus());
        assertEquals(Math.sqrt(13
        ), new Complex(2,3).modulus());
    }
}